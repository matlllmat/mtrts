<?php
// modules/technician/retry_manager.php
// Manages offline sync queue retries with exponential backoff
// GET /modules/technician/retry_manager.php?action=process&wo_id=123
// GET /modules/technician/retry_manager.php?action=status&wo_id=123
